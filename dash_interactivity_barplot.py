...
adf = pd.read_csv(path, encoding="ISO-8859-1", dtype={
                  'Div1Airport': str, 'Div1TailNum': str, 'Div2Airport': str, 'Div2TailNum': str})
...
app.layout = html.Div(children=[
    html.H1('Total number of flights to the destination state split by reporting airline', style={
...
def get_graph(entered_year):
    ...
    # PLOT
    fig = px.bar(bdf, x='DestState', y='Flights',
    ...
    fig.update_layout(title='Flights to Destination State',
                      xaxis_title='Destination state', yaxis_title='Flights')
